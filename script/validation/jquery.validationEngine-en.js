...
//                    "alertTextCheckboxMultiple": "* Please select an option",
                ...
                "phone": {
                    ...
                    "alertText": "* 请输入正确格式的电话号码！<br/> &nbsp;&nbsp;&nbsp;如：010-22226666 或 13522226666"
                },
                "mobilephone":{
                ...
                "number100": {
                    // Number, including positive, negative, and floating decimal. credit: orefalo
                    "regex": /^(?:(?!0\d)\d{1,2}(?:\.\d{1,2})?|100(?:\.0{1,2})?)$/,
                    "alertText": "* 请输入0-100之间数字！"
                },
                "numberandletter": {
                	// Number, including positive, negative, and floating decimal. credit: orefalo
                	"regex": /^(?![a-zA-Z]+$)[\da-zA-Z]+$/,
                	"alertText": "* 请输入字母和数字或只输数字！"
                },
                "exsitspace": {
                	// Number, including positive, negative, and floating decimal. credit: orefalo
                	"regex": /^(?!_)(?!.*?_$)[a-zA-Z0-9_\u4e00-\u9fa5]+$/,
                	"alertText": "* 请输入汉字、数字、字母、下划线！"
                },
                "idcard": {
                	// Number, including positive, negative, and floating decimal. credit: orefalo
