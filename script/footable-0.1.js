...
function light(obj){
	obj.style.background="#fbf8e9";
}
function low(obj){
	obj.style.background=$(obj).attr('bgcol');
}
function lowrow(obj){
	if($(obj).attr('class')=='rowcolor0'){
		obj.style.background="rgb(234, 233, 233)";
	}else{
		obj.style.background="rgb(247, 247, 247)";
	}
}
