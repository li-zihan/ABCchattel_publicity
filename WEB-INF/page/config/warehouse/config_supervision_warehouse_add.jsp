...
<script type="text/javascript" src="script/config/warehouse/warehouse_add.js"></script>
...
<div class="main_content">
	<div class="main_content_orgnization"><p class="navbar"><a href="warehouse/warehouse_list.html">监管仓库</a>> 监管仓库创建</p></div>
	<div class="main_content_line"></div>
		<form class="main_right_div_form" action="warehouse/warehouse_add.html" method="post" id="addWarehouse">
			<table id="warehouse_table_id">
				<tr>
					<td class="main_content_tab" colspan="2">
	         			 	<span class="tab_style" >监管仓库创建</span>
	         		</td>
				</tr>
				<tr>
					<td width="200" align="right" class="pr10">仓库名称:</td>
					<td align="left">
						<input type="text" name="warehouseName" id="warehouseName" class="warehouse_table_id_td validate[required,maxSize[30]] text-input"/>
				...
				<tr>
					...
					<td align="left">
						<input type="text" name="warehouseAddress" id="warehouseAddress" class="warehouse_table_id_td validate[required,maxSize[80]] text-input" />
						<span style="color: red; font-size: 18px;vertical-align: middle;padding-bottom: 5px;">&nbsp;*</span>
					</td>
				</tr>
				...
				<tr>
					...
					<td align="left">
						<select name="wtypeId" class="warehouse_table_id_td1">
							<option value="1">自有库</option>
							<option value="2">第三方库</option>
							<option value="3">出质人库</option>
						</select>
						<span style="color: red; font-size: 18px;vertical-align: middle;padding-bottom: 5px;">&nbsp;*</span>
					</td>
				</tr>
				<tr>
					<td align="right" class="pr10">所属监管公司:</td>
					<td align="left">
						<select name="supvId" class="warehouse_table_id_td1">
							<c:forEach var="row" items="${supvList }">
								<option value="<c:out value="${row.supvId}"/>"><c:out
										value="${row.supvName}" /></option>
							</c:forEach>
						</select>
					<span style="color: red; font-size: 18px;vertical-align: middle;padding-bottom: 5px;">&nbsp;*</span>
					</td>
				...
				<tr class="input_table">
					<td colspan="2">
						<div class="buttontxt">
							<input type="button" value="确定" id="add_btn" class="buttony" onclick="form_submit()"/>
