...
<head>
	...
	<script type="text/javascript">	
		...
		$(function(){
			$('#updatepwfirst').validationEngine();
		});
...
<body>
<form method="post" action="security/password_update.html" id="updatepwfirst">
	 		<div class="main_content" style="margin: 16px 0px 0px 48px;width:907px;height:305pxborder-width: 2px;">
				...
				<table id="userpwd_table_id" style="border-width: 2px;margin-top: -5px;padding-top:20px">
					<tr>
						...
						<td align="left">
                          <input class="userpwd_table_id_td validate[required,maxSize[20],minSize[5]] text-input" style="width: 200px;" type="password" name="oldPassword" id="oldPassword" size="30"/>
					...
					<tr>
						...
						<td align="left">
                          <input class="userpwd_table_id_td validate[required,maxSize[20],minSize[6]] text-input" style="width: 200px;" type="password" name="newPassword" id="newPassword" size="30"/>
                          <span style="color: red; font-size: 18px;vertical-align: middle;padding-bottom: 5px;">&nbsp;*</span>
                      	</td>
					</tr>
					...
					<tr>
						...
						<td align="left">
                          <input class="userpwd_table_id_td validate[required,maxSize[20],minSize[6]] text-input" style="width: 200px;" type="password" name="confirmPassword" id="confirmPassword" size="30"/>
                          <span style="color: red; font-size: 18px;vertical-align: middle;padding-bottom: 5px;">&nbsp;*</span>
                      	</td>
					</tr>
					...
					<tr class="input_table" >
                       <td colspan="2">
                       	<div class="buttontxt" align="center">
	                         <input type="button" value="确认" class="buttony" onclick="fn_updateUserPwd();"/>
